...
| AI handoff protocol | `.ai/README.md`, `.ai/context/project.md`, `.ai/templates/` | tracked `.ai/` records and templates | Research request/result, implementation plan, ADR | `.codex/scripts/test-anchors.ps1 -Strict`; future `ai` CLI tests |
